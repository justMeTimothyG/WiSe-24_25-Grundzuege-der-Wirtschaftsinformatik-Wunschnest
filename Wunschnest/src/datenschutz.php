...
<body class="max-w-screen-xl mx-auto">
    ...
    <div class="w-10/12 mx-auto mt-16">
        ...
        <h1 class="mb-16 text-5xl  font-semibold text-gray-900 my-4">Datenschutz</h1>
    </div>

    <!-- Section: Datenschutz -->
    <section class="w-10/12 mx-auto leading-loose mb-16">
        ...
        <h3 class="font-bold font-xl mt-8 mb-4">
