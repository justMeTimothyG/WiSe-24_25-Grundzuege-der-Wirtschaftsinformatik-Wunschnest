            ...
            <div class="mb-8 sm:rounded-lg">
                <div class="hb us asn asx cni dmm">
                    <ul class="grid grid-cols-3 gap-6">
                        <li class="overflow-hidden rounded-xl border-[1px] border-gray-100 hover:shadow-md dark:border-gray-950">
                            <div class="flex items-center justify-between gap-4 border-b-[1px] bg-gray-50 p-6 dark:border-gray-950 dark:bg-gray-800">
                                ...
                                <div class="font-medium leading-6">Weihnachten</div>
                            ...
                            <dl class="-my-3 px-6 py-4 text-sm">
                                ...
                                <div class="flex justify-between gap-4 border-t-[1px] border-gray-100 py-3 dark:border-gray-700">
                        ...
                        <li class="overflow-hidden rounded-xl border-[1px] border-gray-100 hover:shadow-md dark:border-gray-950">
                            <div class="flex items-center justify-between gap-4 border-b-[1px] bg-gray-50 p-6 dark:border-gray-950 dark:bg-gray-800">
                                ...
                                <div class="font-medium leading-6">Geburtstag</div>
                                <div class="ml-auto" data-headlessui-state="">
                                    <button class="" type="button">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon" class="size-4 text-gray-400">
                                            <path d="M3 10a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM8.5 10a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM15.5 8.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3Z"></path>
                        ...
                        <li class="overflow-hidden rounded-xl border-[1px] border-gray-100 hover:shadow-md dark:border-gray-950">
                            <div class="flex items-center justify-between gap-4 border-b-[1px] bg-gray-50 p-6 dark:border-gray-950 dark:bg-gray-800">
                                ...
                                <div class="font-medium leading-6">Hochzeit</div>
                                <div class="ml-auto" data-headlessui-state="">
                                    <button class="" type="button">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon" class="size-4 text-gray-400">
                                            <path d="M3 10a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM8.5 10a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM15.5 8.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3Z"></path>
                        ...
                        <li class="overflow-hidden rounded-xl border-[1px] border-gray-100 hover:shadow-md dark:border-gray-950">
                            <div class="flex items-center justify-between gap-4 border-b-[1px] bg-gray-50 p-6 dark:border-gray-950 dark:bg-gray-800">
                                ...
                                <div class="font-medium leading-6">Generelle Ideen</div>
                                <div class="ml-auto" data-headlessui-state="">
                                    <button class="" type="button">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon" class="size-4 text-gray-400">
                                            <path d="M3 10a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM8.5 10a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0ZM15.5 8.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3Z"></path>
                        ...
                        <li class="flex cursor-pointer items-center justify-center overflow-hidden rounded-xl border-[1px] border-gray-100 bg-gray-50 text-gray-400 hover:bg-gray-100 dark:border-gray-950 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                            <p class="font-medium leading-6">Neue Liste erstellen</p>

                        </li>
                    </ul>
                </div>
            </div>
            <hr class="my-8 h-2 w-32 rounded-full bg-gray-400 dark:border-gray-700 dark:bg-gray-700">
            <!-- Alternative Darstellung der Listen -->
            <div class="mb-4 flex justify-between align-middle">

                <h2 class="mb-4 dark:text-gray-300">
                    Meine Listen (Alternative)
                </h2>
                <div class="inline-flex rounded-md shadow-sm" role="group">
                    <button type="button" class="rounded-s-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:text-blue-700 focus:ring-2 focus:ring-blue-700 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white dark:focus:text-white dark:focus:ring-blue-500">
                        Alle
            ...
            <div class="mb-8 sm:rounded-lg">
                <div class="hb us asn asx cni dmm">
                    <ul class="grid grid-cols-3 gap-6">
                        ...
                        include __DIR__ . "/components/wunschlisten-alternative.php";
