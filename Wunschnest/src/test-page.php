...
<body>
    <div class="flex">
        <div class="sticky">
            <!-- Sidebar on the Side -->
            <nav id="sidebar" class="bg-gray-100 w-64 border-gray-200 h-screen sticky top-0 px-4 flex flex-col gap-4 flex-start justify-between py-4 ">
                <div class="flex gap-4 items-center active rounded-lg p-3">
                    <a href="/">
                        <img src="./assets/logo.svg" class="size-6" alt="WunschNest Logo" />
                    </a>
                    <span class="self-center text-xl font-semibold whitespace-nowrap">WunschNest</span>
                </div>
                <div class="flex-grow pt-8 flex flex-col gap-12">

                    <ul id="actions">
                        <li>
                            <div class="flex gap-4 items-center active bg-orange-300 rounded-lg p-3">
                                <span>
                    ...
                    <ul class="flex flex-col gap-2">
                        ...
                        <li>
                            <div class="flex gap-4 items-center active bg-gray-500 text-white hover:shadow-md rounded-lg p-3 py-2">
                                <span>
                        ...
                        <li>
                            <div class="flex gap-4 items-center p-3 rounded-lg hover:bg-gray-200 py-2">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div>
                        <h3 class="text-sm font-semibold ml-3 pb-2 uppercase">Favoriten</h3>
                        <ul>
                            <li>
                                <div class="flex gap-4 items-center rounded-lg p-3 py-2 hover:bg-gray-200">
                            ...
                            <li>
                                <div class="flex gap-4 items-center rounded-lgp-3 py-2 hover:bg-gray-200">
                                    <!-- <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path>
                                        </svg>
                                    </span> -->
                                    <h2 class="text-md">Archiv</h2>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div>
                    <div class="flex gap-4 items-center p-3">
                        <div class="inline-flex items-center justify-center s-6 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
        ...
        <!-- Main Content -->
        <div class="p-8 max-w-screen-xl w-full mx-auto">
            ...
            <div class="flex gap-8">
                <div class="flex-grow p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 flex flex-col items-center">
                ...
                <div class="flex-grow p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 flex flex-col items-center">
                    ...
                    <h5 class="mb-2 text-2xl font-bold text-gray-900 ">4</h5>
                </div>
                <div class="flex-grow p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 flex flex-col items-center">
            ...
            <div class="flex gap-4">
                <button type="button" class="relative inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-gray-700 bg-white border border-gray-200 rounded-lg hover:text-white hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Elektronik
                    <div class="absolute inline-flex items-center justify-center px-2 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -end-2 dark:border-gray-900">13</div>
                </button>
                <button type="button" class="relative inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-gray-700 bg-white border border-gray-200 rounded-lg hover:text-white hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Haushalt
                    <div class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -end-2 dark:border-gray-900">7</div>
                </button>
                <button type="button" class="relative inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-gray-700 bg-white border border-gray-200 rounded-lg hover:text-white hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Hobby
                ...
                <button type="button" class="relative inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-gray-700 bg-white border border-gray-200 rounded-lg hover:text-white hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Gesundheit
                    <div class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -end-2 dark:border-gray-900">9</div>
                </button>
                <button type="button" class="relative inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-gray-700 bg-white border border-gray-200 rounded-lg hover:text-white hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Küche
                    <div class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -end-2 dark:border-gray-900">2</div>
            ...
            <div class="flex justify-between align-middle mb-4 mt-8">
